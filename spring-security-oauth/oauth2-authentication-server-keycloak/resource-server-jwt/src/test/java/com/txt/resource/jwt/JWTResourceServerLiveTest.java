...
import com.txt.resource.jwt.entities.Foo;
...
public class JWTResourceServerLiveTest {
    ...
    private final String authorizeUrlPattern = "http://localhost:8083/auth/realms/syspro/protocol/openid-connect/auth?response_type=code&client_id=fooClient&scope=%s&redirect_uri=" + redirectUrl;
