package com.txt.resource.opaque;
...
public class OpaqueResourceServerLiveTest {
    ...
    private final String authorizeUrlPattern = "http://localhost:8083/auth/realms/syspro/protocol/openid-connect/auth?response_type=code&client_id=barClient&scope=%s&redirect_uri=" + redirectUrl;
