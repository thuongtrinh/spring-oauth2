...
public class AuthorizationServerLiveTest {
    ...
    public static final String AUTHORIZE_CODE_URL = "http://localhost:8083/auth/realms/syspro/protocol/openid-connect/auth?response_type=code&client_id=jwtClient&scope=read&redirect_uri=";
    public static final String TOKEN_URL = "http://localhost:8083/auth/realms/syspro/protocol/openid-connect/token";
    public static final String INTROSPECT_URL = "http://localhost:8083/auth/realms/syspro/protocol/openid-connect/token/introspect";
    public static final String USER_INFO_URL = "http://localhost:8083/auth/realms/syspro/protocol/openid-connect/userinfo";
    ...
    public static final String OIDC_DISCOVERY_URL = "http://localhost:8083/auth/realms/syspro/.well-known/openid-configuration";
